...
import chefPhoto1 from '../../assets/carousel/4.jpg'; // Primeira foto do chef (esquerda)
import chefPhoto2 from '../../assets/carousel/5.jpg'; // Segunda foto do chef (direita)
import chefPhoto3 from '../../assets/carousel/6.jpg'; // Terceira foto do chef (esquerda)
  ...
  return (
    <section id="biografia" className={styles.biographySection}>
      <div className="container">
        ...
        {/* Bloco 1: Foto Esquerda (4.jpg), Texto Direita */}
        <div className={`${styles.biographyContentBlock}`}> {/* Não precisa de leftImageBlock explícito */}
        ...
        {/* Bloco 2: Foto Direita (5.jpg), Texto Esquerda */}
        <div className={`${styles.biographyContentBlock} ${styles.imageRight}`}> {/* AQUI aplicamos a classe para imagem à direita */}
          <div className={styles.chefImageContainer}> {/* ALTERADO: IMAGEM AGORA VEM PRIMEIRO NO JSX AQUI TAMBÉM */}
            <img src={chefPhoto2} alt="Chef Thierry com forno a lenha" className={styles.chefImage} loading="lazy" />
          </div>
          <div className={styles.chefText}> {/* Texto vem depois no JSX */}
            <p>
        ...
        {/* Bloco 3: Foto Esquerda (6.jpg), Texto Direita */}
        <div className={`${styles.biographyContentBlock}`}> {/* Não precisa de leftImageBlock explícito */}
          <div className={styles.chefImageContainer}>
