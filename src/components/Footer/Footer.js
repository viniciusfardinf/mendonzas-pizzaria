...
import { FaWhatsapp, FaInstagram } from 'react-icons/fa'; // Ícones do React Icons

function Footer() {
  return (
    <footer className={styles.footer} id="contato"> {/* ID para o link do header */}
      <div className={`${styles.footerContainer} container`}>

        {/* COLUNA 1: Redes Sociais */}
        <div className={styles.socialMediaColumn}>
          <h4>Redes Sociais</h4>
          {/* NOVO: Texto de contato */}
        ...
        {/* COLUNA 3: Onde Estamos (Mapa) */}
<div className={styles.mapColumn}>
          <h4>Onde Estamos</h4>
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3744.179308107954!2d-41.40728468846187!3d-20.21045298150493!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xbb939c36d0f62d%3A0xc3f17d747a83d7a8!2sRua%20Manoel%20Alonso%20Portela%2C%20Muniz%20Freire%20-%20ES%2C%2029380-000!5e0!3m2!1spt-BR!2sbr!4v1700000000000!5m2!1spt-BR!2sbr" // Coloque o SRC do seu mapa real aqui!
            width="100%"
            height="200"
            style={{ border: 0 }}
            allowFullScreen=""
